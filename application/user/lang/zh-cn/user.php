...
return [
    ...
    'Change'                                     => '修改',
    'Click to edit'                              => '点击编辑',
    'Email/Mobile/Username'                      => '邮箱/手机/账号',
    'Sign up successful'                         => '注册成功',
    'Email active successful'                    => '邮箱激活成功',
    'Username can not be empty'                  => '账号不能为空',
    'Username must be 3 to 30 characters'        => '账号必须3-30个字符',
    'Username must be 6 to 30 characters'        => '账号必须6-30个字符',
