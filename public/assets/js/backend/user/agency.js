define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/agency/index' + location.search,
                    add_url: 'user/agency/add',
                    edit_url: 'user/agency/edit',
                    del_url: 'user/agency/del',
                    multi_url: 'user/agency/multi',
                    import_url: 'user/agency/import',
                    table: 'user_agency',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'user/agency/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
